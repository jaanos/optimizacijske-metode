...
\NewEnviron{razvoz@grafG}{
    ...
    \povezava{a}{e}{4}[sloped]{above}[bend left=15]
    ...
    \povezava{e}{c}{1}[sloped]{above}[bend left=15]
    \povezava{e}{g}{6}[sloped]{below}[bend left=15]
    \povezava{e}{i}{3}[sloped]{below}[bend right=15]
